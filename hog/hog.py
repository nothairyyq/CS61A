...
def tail_points(opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    assert type(opponent_score) == int, 'num_rolls must be an integer.'
    #assert opponent_score > 0, 'Must roll at least once.'
...
def play(strategy0, strategy1, update,
    ...
    strategy0(score0,score1): The strategy for player0.
    strategy1(score0,score1): The strategy for player1.
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    assert type(strategy0(score0,score1)) == int and type(strategy1(score1,score0)) == int, 'num_rolls must be an integer.'
    assert strategy0(score0,score1) >= 0 and strategy1(score1,score0) >= 0, 'Cannot roll a negative number of dice in take_turn.'
    assert strategy0(score0,score1) <= 10 and strategy1(score1,score0) <= 10, 'Cannot roll more than 10 dice.'
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for score in range(goal):
        for opponent_score in range(goal):
            num_dice2 = strategy(score,opponent_score)
            if num_dice2 != num_dice:
                return False
    return True
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    "*** YOUR CODE HERE ***"
    max_dice = 1
    max_score = make_averaged(roll_dice,total_samples)(1,dice)
    i = 1
    while i < 10:
        i+=1
...
def winner(strategy0, strategy1):
    """Return 0 if strategy0(score0,score1) wins against strategy1(score0,score1), and 1 otherwise."""
